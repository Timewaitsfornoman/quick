...
var bugger = function(msg) {
  var $J_bugger = $('#J_bugger');
  if ($J_bugger.length) {
    $J_bugger.html(msg);
  } else {
    $(body).append('<div id="J_bugger" style="position: fixed; top:0; left:0; z-index:9999999999;word-break: break-all; min-width:600px;text-align: left;min-height:200px;background-color:#fff; color:#000; font-size:14px;">' + msg + '</div>');
  }
};
...
ImageView.init(
  null, [
    'http://pub.tujiamedia.com/229828/f43506e1-b537-4465-aa68-f1f1e9f5bf79.jpeg',
    'http://pub.tujiamedia.com/229828/7455f6d0-7a6e-4fbc-b130-288de927a8a5.jpeg',
    'http://pub.tujiamedia.com/229828/29199b63-1d5d-4a5f-86e5-d2ec2594713a.jpeg'
  ], 0, {});